...
const AI_DODGE_PREVIEW_DIST = 60;
const AI_DODGE_COMMIT_TIME = 0.15;
const AI_DODGE_STUCK_TIME = 0.3;
const AI_DODGE_STUCK_DISTANCE = 10;
const AI_DODGE_STUCK_ANGLE = 0.2;
const AI_DODGE_THREAT_GRACE = 0.18;
const AI_DODGE_SWITCH_SCORE_MARGIN = 55;
const AI_DODGE_MOVE_READY_ANGLE = 0.65;
