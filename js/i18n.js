...
const I18N_DICT = {
    ...
    mapSize:      { zh: '地图大小', en: 'Map Size' },
    mapSizeSubtitle: { zh: '设置随机地图宽高范围', en: 'Set random map width and height ranges' },
    mapSizeHint:  { zh: '左右调整数值，返回保存并生效', en: 'Adjust values, then go back to save' },
    mapSizeMinCols: { zh: '最小宽度', en: 'Min Width' },
    mapSizeMinRows: { zh: '最小高度', en: 'Min Height' },
    mapSizeMaxCols: { zh: '最大宽度', en: 'Max Width' },
    mapSizeMaxRows: { zh: '最大高度', en: 'Max Height' },
    mapSizeValueSuffix: { zh: '格', en: ' cells' },
    ...
    controlsSubtitle: { zh: '直接在屏幕上调整触摸控制器', en: 'Adjust touch controls directly on the screen' },
